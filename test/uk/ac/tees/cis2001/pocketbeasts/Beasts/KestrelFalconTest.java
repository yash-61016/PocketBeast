 ...
 * @author Yash Patel
 */
public class KestrelFalconTest {

    private KestrelFalcon instance;
    
    public KestrelFalconTest() {
    }
    
    @BeforeClass
    public static void setUpClass() {
        System.out.println("Testing KestrelFalcon class...");
    }
    
    @AfterClass
    public static void tearDownClass() {
        System.out.println("Finished testing KestrelFalcon class.");
    }
    
    @Before
    public void setUp() {
        instance = new KestrelFalcon();
    }
...
//    @Ignore
    ...
    public void testGetName() {
        ...
        String expResult = "Kestrel Falcon";
...
//    @Ignore
    ...
    public void testToString() {
        ...
        String expResult = "Kestrel Falcon (KF) Mana Cost/3 Attack/4 Health/3";
