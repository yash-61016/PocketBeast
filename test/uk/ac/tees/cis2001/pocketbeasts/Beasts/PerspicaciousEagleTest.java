 ...
 * @author Yash Patel
 */
public class PerspicaciousEagleTest {

    private PerspicaciousEagle instance;
    
    public PerspicaciousEagleTest() {
    }
    
    @BeforeClass
    public static void setUpClass() {
        System.out.println("Testing PerspicaciousEagle class...");
    }
    
    @AfterClass
    public static void tearDownClass() {
        System.out.println("Finished testing PerspicaciousEagle class.");
    }
    
    @Before
    public void setUp() {
        instance = new PerspicaciousEagle();
    }
...
//    @Ignore
    ...
    public void testGetName() {
        ...
        String expResult = "Perspicacious Eagle";
...
//    @Ignore
    ...
    public void testToString() {
        ...
        String expResult = "Perspicacious Eagle (PE) Mana Cost/3 Attack/3 Health/3";
